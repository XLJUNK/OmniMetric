...
export const DICTIONARY: Record<LangType, any> = {
    EN: {
        ...
        titles: {
            ...
            omni_resonance: "Portfolio Sync (Dynamic Analysis)"
        },
        methodology: {
        ...
        legal_text: {
            ...
            t3: "This project is a technical demonstration platform that combines advanced system engineering with macroeconomic analysis logic.",
        ...
        labels: {
            ...
            omni: 'PORTFOLIO\nSYNC',
            summary: "SUMMARY",
            stocks_rates: "STOCKS & RATES",
            rates_gravity: "Market Gravity (Yields)",
            crypto: "CRYPTO",
            ...
            tickers: {
                ...
                USDJPY: "USD/JPY", EURUSD: "EUR/USD", GBPUSD: "GBP/USD", AUDUSD: "AUD/USD", USDCAD: "USD/CAD", USDINR: "USD/INR", USDSAR: "USD/SAR", DXY: "Dollar Index",
        ...
        subpages: {
            about: {
                ...
                platform_statement: "This project is a technical demonstration platform that combines advanced system engineering with macroeconomic analysis logic."
            },
            legal: {
            ...
            omni_resonance: {
                ...
                subtitle: "Proprietary Macro Logic Calculator & Alignment Simulator / V1.0-ALPHA",
                alpha_notice: "ALPHA NOTICE: This is a technical prototype. It localizes macro signal vectors against custom portfolio distributions to observe correlation mapping (Resonance).",
                alpha_notice_label: "ALPHA NOTICE",
                total_allocation_label: "Total Allocation: 100.0% (Normalized)",
                tech_report: "Technical Observation Report",
                observation: "Observation",
                technical_insight: "Technical Insight",
                legal_title: "Legal Disclaimer",
                allocations_title: "Asset Allocation",
                allocations: {
                    equities: "Equities",
                    crypto: "Crypto",
                    metals: "Metals",
    ...
    JP: {
        ...
        titles: {
            ...
            omni_resonance: "資産共鳴 (ポートフォリオ・シンクロ)"
        },
        methodology: {
            title: "GMS QUANT METHODOLOGY",
        ...
        legal_text: {
            ...
            t2: "",
            t3: "当プロジェクトは システムエンジニアリングの高度な技術と、マクロ経済解析ロジックを融合させた技術実証プラットフォームである。",
        ...
        labels: {
            ...
            tickers: {
                ...
                USDJPY: "ドル円", EURUSD: "ユーロドル", GBPUSD: "ポンドドル", AUDUSD: "豪ドル/ドル", USDCAD: "米ドル/加ドル", USDINR: "ドル/ルピー", USDSAR: "ドル/リヤル", DXY: "ドル指数",
        ...
        subpages: {
            about: {
                ...
                platform_statement: "当プロジェクトは システムエンジニアリングの高度な技術と、マクロ経済解析ロジックを融合させた技術実証プラットフォームです。"
            },
            legal: {
            ...
            omni_resonance: {
                title: "OmniResonance\n(資産共鳴プロトタイプ)",
                subtitle: "独自ロジックによるマクロ相関計算機 / V1.0-ALPHA",
                alpha_notice: "ALPHA通知: これは技術的なプロトタイプです。カスタムポートフォリオの配分に対してマクロ信号ベクトルを局在化し、相関マッピング（レゾナンス）を観測します。",
                alpha_notice_label: "ALPHA通知",
                total_allocation_label: "合計配分: 100.0% (正規化済み)",
                tech_report: "技術観測レポート",
                observation: "観測",
                technical_insight: "技術的見解",
                legal_title: "法的免責事項",
                allocations_title: "アセット構成",
                allocations: {
                    equities: "株式",
                    crypto: "暗号資産",
                    metals: "コモディティ",
    ...
    CN: {
        ...
        legal_text: {
            ...
            t3: "本项目是一个将高级系统工程技术与宏观经济分析逻辑相结合的技术演示平台。",
            copyright: "Powered by OmniMetric Project"
        },
        regime: {
            bull: "风险偏好",
        ...
        labels: {
            ...
            tickers: {
                ...
                USDJPY: "美元/日元", EURUSD: "欧元/美元", GBPUSD: "英镑/美元", AUDUSD: "澳元/美元", USDCAD: "美元/加元", USDINR: "美元/卢比", USDSAR: "美元/里亚尔", DXY: "DXY Dollar Index",
        ...
        subpages: {
            about: {
                ...
                platform_statement: "本项目是一个将高级系统工程技术与宏观经济分析逻辑相结合的技术演示平台。"
            },
            legal: {
                title: "法律声明与合规性",
                disclaimer: "免责声明",
            ...
            omni_resonance: {
                title: "OmniResonance\n(资产共鸣原型)",
                subtitle: "独家算法宏观对齐计算器 / V1.0-ALPHA",
    ...
    ES: {
        ...
        titles: {
            ...
            ai_disclaimer: "Este análisis es el resultado de un estudio multifacético realizado por AI y no garantiza la precisión de su contenido.",
        ...
        terms: {
            VIX: { def: "波动率指数。", benchmark: "Ref: >20 Precaución." },
            MOVE: { def: "债券市场波动率。", benchmark: "Ref: >120 表明系统性压力。" },
            NFCI: { def: "国家金融状况指数。", benchmark: "Ref: 正值为紧缩，负值为宽松。" },
            HY_SPREAD: { def: "高收益债券利差。", benchmark: "Ref: >5% 表明信贷压力。" },
            COPPER_GOLD: { def: "铜金比率。", benchmark: "Ref: 上升表明经济扩张。" },
            BREADTH: { def: "市场广度。", benchmark: "Ref: 广泛的参与表明牛市健康。" },
            SPY: { def: "标准普尔 500 ETF。", benchmark: "Ref: 趋势向上为风险开启。" },
            TNX: { def: "10年期国债收益率。", benchmark: "Ref: >4.5% 压低估值。" },
            DXY: { def: "美元指数。", benchmark: "Ref: >105 导致流动性紧缩。" },
            YIELD_SPREAD: { def: "收益率曲线。", benchmark: "Ref: 倒挂为衰退信号。" }
        },
        legal_text: {
            ...
            t3: "Este proyecto es una plataforma de demostración técnica que combina ingeniería de sistemas avanzada con lógica de análisis macroeconómico.",
            copyright: "Powered by OmniMetric Project"
        },
        regime: {
        ...
        labels: {
            ...
            tickers: {
                ...
                USDJPY: "USD/JPY", EURUSD: "EUR/USD", GBPUSD: "GBP/USD", AUDUSD: "AUD/USD", USDCAD: "USD/CAD", USDINR: "USD/INR", USDSAR: "USD/SAR", DXY: "Índice Dólar",
        ...
        subpages: {
            about: {
                ...
                data_sources_content: "Federal Reserve Economic Data (FRED), Índices de Volatilidad de CBOE, Yahoo Finance, Financial Modeling Prep, Alternative.me Crypto Fear & Greed",
                disclaimer_title: "Aviso Legal Importante",
                disclaimer_content: "OmniMetric se proporciona solo con fines informativos y no constituye asesoramiento de inversión. Todos los datos provienen de APIs públicas. No garantizamos la exactitud. Las decisiones de inversión son responsabilidad exclusiva del usuario.",
                ...
                platform_statement: "Este proyecto es una plataforma de demostración técnica que combina ingeniería de sistemas avanzada con lógica de análisis macroeconómico."
            },
            legal: {
            ...
            omni_resonance: {
                ...
                subtitle: "Calculadora de Lógica Macro Propietaria y Simulador / V1.0-ALPHA",
    ...
    HI: {
        ...
        legal_text: {
            ...
            t3: "यह प्रोजेक्ट एक तकनीकी प्रदर्शन मंच है जो उन्नत सिस्टम इंजीनियरिंग को व्यापक आर्थिक विश्लेषण तर्क के साथ जोड़ता है।",
            copyright: "Powered by OmniMetric Project"
        },
        regime: {
            bull: "ज़ोखिम वरीयता",
        ...
        labels: {
            ...
            tickers: {
                ...
                USDJPY: "USD/JPY", EURUSD: "EUR/USD", GBPUSD: "GBP/USD", AUDUSD: "AUD/USD", USDCAD: "USD/CAD", USDINR: "USD/INR", USDSAR: "USD/SAR", DXY: "डॉलर सूचकांक",
        ...
        subpages: {
            about: {
                ...
                platform_statement: "यह प्रोजेक्ट एक तकनीकी प्रदर्शन मंच है जो उन्नत सिस्टम इंजीनियरिंग को व्यापक आर्थिक विश्लेषण तर्क के साथ जोड़ता है।"
            },
            legal: {
                title: "कानूनी नोटिस",
                disclaimer: "अस्वीकरण",
            ...
            omni_resonance: {
                ...
                subtitle: "प्रोपराइटरी मैक्रो लॉजिक कैलकुलेटर और सिम्युलेटर / V1.0-ALPHA",
    ...
    ID: {
        ...
        legal_text: {
            ...
            t3: "Proyek ini adalah platform demonstrasi teknis yang menggabungkan rekayasa sistem tingkat lanjut dengan logika analisis makroekonomi.",
            copyright: "Powered by OmniMetric Project"
        },
        regime: {
        ...
        labels: {
            ...
            tickers: {
                ...
                USDJPY: "USD/JPY", EURUSD: "EUR/USD", GBPUSD: "GBP/USD", AUDUSD: "AUD/USD", USDCAD: "USD/CAD", USDINR: "USD/INR", USDSAR: "USD/SAR", DXY: "Indeks Dolar",
                SPY: "S&P 500", QQQ: "Nasdaq 100", IWM: "Russell 2000", RSP: "S&P 500 Equal Weight", HYG: "High Yield Bond", NIFTY: "Nifty 50",
                DAX: "DAX 40", CAC40: "CAC 40", FTSE: "FTSE 100", STOXX600: "Stoxx 600",
                NIKKEI: "Nikkei 225", HANGSENG: "Hang Seng", ASX200: "ASX 200",
        ...
        subpages: {
            about: {
                ...
                platform_statement: "Proyek ini adalah platform demonstrasi teknis yang menggabungkan rekayasa sistem tingkat lanjut dengan logika analisis makroekonomi."
            },
            legal: {
            ...
            omni_resonance: {
                ...
                subtitle: "Kalkulator Logika Makro Kepemilikan & Simulator / V1.0-ALPHA",
    ...
    AR: {
        ...
        legal_text: {
            ...
            t3: "هذا المشروع هو منصة عرض تقنية تجمع بين هندسة الأنظمة المتقدمة ومنطق التحليل الاقتصادي الكلي.",
        ...
        labels: {
            ...
            tickers: {
                ...
                USDJPY: "USD/JPY", EURUSD: "EUR/USD", GBPUSD: "GBP/USD", AUDUSD: "AUD/USD", USDCAD: "USD/CAD", USDINR: "USD/INR", USDSAR: "USD/SAR", DXY: "مؤشر الدولار",
        ...
        subpages: {
            about: {
                ...
                platform_statement: "هذا المشروع هو منصة عرض تقنية تجمع بين هندسة الأنظمة المتقدمة ومنطق التحليل الاقتصادي الكلي."
            },
            legal: {
                title: "إشعار قانوني",
            ...
            omni_resonance: {
                ...
                subtitle: "آلة حاسبة لمنطق الماكرو المملوكة ومحاكي المحاذاة / V1.0-ALPHA",
    ...
    DE: {
        ...
        legal_text: {
            ...
            t3: "Dieses Projekt ist eine technische Demonstrationsplattform, die fortschrittliches System Engineering mit makroökonomischer Analyselogik kombiniert.",
            copyright: "Powered by OmniMetric Project"
        },
        regime: {
        ...
        subpages: {
            about: {
                ...
                platform_statement: "Dieses Projekt ist eine technische Demonstrationsplattform, die fortschrittliches System Engineering mit makroökonomischer Analyselogik kombiniert."
            },
            legal: {
            ...
            omni_resonance: {
                ...
                subtitle: "Proprietärer Makro-Logik-Rechner & Simulator / V1.0-ALPHA",
        ...
        labels: {
            ...
            tickers: {
                ...
                G_REIT: "Global REIT", US_HOUSING: "US Housing", LOGISTICS: "Logistics REIT", INFRA: "Infrastructure",
                HY_BOND: "High Yield", IG_BOND: "Inv Grade", TIPS: "TIPS", SHY: "Short Gov",
                BALTIC: "Baltic Dry Index", SHIPPING: "Schifffahrt", AGRI: "Agrarrohstoffe",
                SEMIS: "Semis", DEFENSE: "Defense", RARE_EARTH: "Rare Earth", CYBER: "Cyber",
                SILVER: "Silber", USDCNY: "USD/CNY",
                VIX: "VIX Volatility", TNX: "US 10Y Yield", MOVE: "MOVE Index", CRYPTO_SENTIMENT: "Crypto Fear & Greed"
            },
            search_placeholder: "Search Knowledge Base...",
            wiki_deep_dive: "Deep Dive Analysis"
    ...
    FR: {
        ...
        legal_text: {
            ...
            t3: "Ce projet est une plateforme de démonstration technique qui combine l'ingénierie système avancée avec une logique d'analyse macroéconomique.",
        ...
        subpages: {
            about: {
                ...
                platform_statement: "Ce projet est une plateforme de démonstration technique qui combine l'ingénierie système avancée avec une logique d'analyse macroéconomique."
            },
            legal: {
                ...
                usage_content: "Le scraping automatisé non autorisé, le minage de données ou l'utilisation pour l'entraînement d'IA est strictement interdit. L'utilisation commerciale nécessite une licence spécifique. En utilisant ce terminal, vous acceptez ces conditions légales spécifiques du projet."
            },
            archive: {
            ...
            omni_resonance: {
                ...
                subtitle: "Calculateur de Logique Macro Propriétaire & Simulateur / V1.0-ALPHA",
        ...
        labels: {
            ...
            tickers: {
                BTC: "Bitcoin", ETH: "Ethereum", SOL: "Solana",
                GOLD: "Gold", OIL: "WTI Crude Oil", COPPER: "Copper", NATGAS: "Natural Gas",
                USDJPY: "USD/JPY", EURUSD: "EUR/USD", GBPUSD: "GBP/USD", AUDUSD: "AUD/USD", USDCAD: "USD/CAD", USDINR: "USD/INR", USDSAR: "USD/SAR", DXY: "Indice Dollar",
                SPY: "S&P 500", QQQ: "Nasdaq 100", IWM: "Russell 2000", RSP: "S&P 500 Equal Weight", HYG: "High Yield Bond", NIFTY: "Nifty 50",
                DAX: "DAX 40", CAC40: "CAC 40", FTSE: "FTSE 100", STOXX600: "Stoxx 600",
                NIKKEI: "Nikkei 225", HANGSENG: "Hang Seng", ASX200: "ASX 200",
                G_REIT: "Global REIT", US_HOUSING: "US Housing", LOGISTICS: "Logistics REIT", INFRA: "Infrastructure",
                HY_BOND: "High Yield", IG_BOND: "Inv Grade", TIPS: "TIPS", SHY: "Short Gov",
                BALTIC: "Indice Baltic Dry", SHIPPING: "Transport maritime", AGRI: "Agriculture",
                SEMIS: "Semis", DEFENSE: "Defense", RARE_EARTH: "Rare Earth", CYBER: "Cyber",
                SILVER: "Argent", USDCNY: "USD/CNY",
                VIX: "VIX Volatility", TNX: "US 10Y Yield", MOVE: "MOVE Index", CRYPTO_SENTIMENT: "Crypto Fear & Greed"
            },
            search_placeholder: "Search Knowledge Base...",
            wiki_deep_dive: "Deep Dive Analysis"
