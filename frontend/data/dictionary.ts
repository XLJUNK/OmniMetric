...
export const DICTIONARY = {
    ...
    JP: {
        ...
        legal_text: {
            t1: "オムニ・メトリック (究極のアセットハブ) は情報提供のみを目的としており、投資助言ではありません。\n\n本サイトの分析は独自のアルゴリズムによって生成されたものであり、無断でのAI学習、データマイニング、および商用目的の自動スクレイピングは固く禁じられています。\n\n本サイトへのアクセスをもって、これらの条件に同意したものとみなされます。\n\n過去の実績は将来の成果を保証するものではありません。市場データは遅延する場合があります。",
            t2: "",
