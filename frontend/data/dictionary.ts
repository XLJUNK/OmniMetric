...
export const DICTIONARY: Record<LangType, any> = {
    EN: {
        ...
        subpages: {
            ...
            omni_resonance: {
                ...
                subtitle: "Macro Alignment Simulator / V1.0-ALPHA",
    ...
    JP: {
        ...
        subpages: {
            ...
            omni_resonance: {
                title: "OmniResonance プロトタイプ",
                subtitle: "マクロ・アライメント・シミュレーター / V1.0-ALPHA",
