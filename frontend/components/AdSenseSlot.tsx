...
export const AdSenseSlot = ({ variant = 'responsive', className = '' }: AdSenseSlotProps) => {
    ...
    return (
        <div
            className={`w-full bg-[#050505] border border-dashed border-slate-800 rounded-lg flex items-center justify-center overflow-hidden relative group ${heightClass} ${className}`}
        >
            {/* Background Pattern */}
            ...
            <div className="flex flex-col items-center gap-2 z-10">
                <span className="text-[10px] font-mono text-slate-600 uppercase tracking-widest border border-slate-800 px-2 py-1 rounded">
                    [AD: Sponsored]
                </span>
