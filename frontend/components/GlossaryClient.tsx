        ...
        <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row">
            ...
            <main className="flex-1 p-4 md:p-12 lg:p-16">
                ...
                <div className="space-y-20">
                    {(() => {
                        let globalTermIndex = 0;
                        return categories.map((cat, categoryIndex) => (
                                    ...
                                    <div className="grid grid-cols-1 gap-6">
                                        {groupedData[cat].map((item, index) => (
                                            <React.Fragment key={item.id}>
                                                ...
                                                {(globalTermIndex + 1) % 5 === 0 && (
                                                    <div className="py-2">
                                                        <TVPartnerCard lang={lang} variant="default" />
                                                    </div>
                                                )}

                                                {/* Sequential Text Ad Injection (Every 10 terms) */}
                                                {(() => {
                                                    globalTermIndex++;
                                                    if (globalTermIndex % 10 === 0) {
                                                        return (
                                                            <div className="py-4 border-y border-slate-100 dark:border-white/5 my-8">
                                                                <AdComponent slot="2602883383" format="fluid" layout="in-article" minHeight="100px" />
                                                            </div>
                                                        );
                                                    }
                                                    return null;
