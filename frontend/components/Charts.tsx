    ...
    return (
        <div className="w-full relative mt-2 mb-2">
            ...
            <div className="flex justify-between px-1 mt-1 relative z-0">
                <span className="text-[8px] md:text-[10px] font-bold text-[#ef4444] uppercase tracking-widest drop-shadow-sm">Defensive</span>
                <span className="text-[8px] md:text-[10px] font-bold text-slate-400 uppercase tracking-widest drop-shadow-sm">Neutral</span>
                <span className="text-[8px] md:text-[10px] font-bold text-[#3b82f6] uppercase tracking-widest drop-shadow-sm">Accumulate</span>
            </div>
        </div>
    );
};
