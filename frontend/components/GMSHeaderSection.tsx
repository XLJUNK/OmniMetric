    ...
    return (
        <div className="w-full">
            ...
            <div className="max-w-[1600px] mx-auto w-full px-4 md:px-6 py-4 border-b border-slate-800 relative z-10 bg-[#0A0A0A]">
                <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start sm:mb-6 gap-6 relative z-50">
                    <div className="pointer-events-auto cursor-pointer text-center sm:text-left" onClick={() => router.push(`/?lang=${lang}`)}>
                        ...
                        <h2 className="text-[10px] sm:text-xs md:text-base font-bold text-sky-500 tracking-[0.2em] uppercase mt-1">Global Macro Signal (GMS)</h2>
                    </div>

                    <div className="flex flex-col items-center sm:items-end pointer-events-auto transition-all duration-300 w-full sm:w-auto">
                        {/* LANGUAGE SWITCHER */}
                        <div className="relative z-[10000] mb-4 sm:mb-0 pointer-events-auto">
                            ...
                            {isLangOpen && (
                                <div className="absolute top-full right-1/2 translate-x-1/2 sm:right-0 sm:translate-x-0 mt-1 w-24 bg-[#1e293b] border border-[#fef3c7]/30 rounded shadow-xl overflow-hidden z-[10001] pointer-events-auto ring-1 ring-[#fef3c7]/20">
                        ...
                        {/* STATUS, DATE */}
                        <div className="flex flex-col items-center sm:items-end gap-1 sm:mt-10">
                            <div className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></span>
                                <span className="text-[8px] sm:text-[9px] text-green-500 font-mono font-bold tracking-[0.2em] uppercase">System Operational</span>
                            </div>
                            <span className="text-[8px] sm:text-[9px] text-slate-500 font-bold uppercase tracking-widest">{data.last_updated}</span>
                        </div>
                    </div>
                </div>
            </div>
