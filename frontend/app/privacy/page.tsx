...
export async function generateMetadata(): Promise<Metadata> {
    return getMultilingualMetadata('/privacy', 'EN', "PRIVACY POLICY", "Privacy Policy and Data Protection practices for OmniMetric Terminal.");
}
...
export default async function PrivacyPage() {
    ...
    const jsonLd = {
        ...
        "@type": "PrivacyPolicy",
        "name": privacy.title,
        "url": `https://gms.omni-metric.com/privacy`,
