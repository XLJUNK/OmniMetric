...
export async function generateMetadata(): Promise<Metadata> {
    return getMultilingualMetadata('/terms', 'EN', "Terms of Service | OmniMetric Terminal", "Terms and Conditions, Disclaimers, and Usage Restrictions for OmniMetric.");
}
            ...
            <TerminalPage pageKey="legal" lang="EN" selectorMode="path">
                <div className="max-w-4xl mx-auto space-y-8 text-left" dir="ltr">
                    ...
                    <section id="terms" className="!border-2 !border-red-500 bg-red-50 dark:bg-red-950/20 !rounded-xl p-6 space-y-4">
                        <h2 className="text-xl font-black text-red-600 dark:text-red-400 uppercase tracking-wide flex items-center gap-2">
                        ...
                        <div className="space-y-3 text-sm text-red-900 dark:text-red-100 leading-relaxed font-medium">
                            ...
                            <ul className="list-disc space-y-2 text-red-800 dark:text-red-200 pl-6">
                        ...
                        <section key={idx} className={`${section.title.includes('Modifications') ? '' : 'bg-transparent dark:bg-[#111]'} !border ${section.title.includes('Prohibited') ? '!border-yellow-500/30' : '!border-slate-200 dark:!border-slate-800'} !rounded-xl p-6 space-y-4 shadow-sm dark:shadow-none`}>
                            ...
                            {section.list && (
                                <div className="space-y-3 text-sm text-slate-700 dark:text-slate-300">
                                    <ul className="list-disc space-y-2 text-slate-600 dark:text-slate-400 pl-6">
