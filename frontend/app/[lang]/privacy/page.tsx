...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return getMultilingualMetadata('/privacy', normalizedLang, "PRIVACY POLICY", "Privacy Policy and Data Protection practices for OmniMetric Terminal.");
}
...
export default async function PrivacyPage({ params }: Props) {
    ...
    const jsonLd = {
        ...
        "@type": "PrivacyPolicy",
        "name": privacy.title,
        "url": `https://gms.omni-metric.com/${lang}/privacy`,
                            ...
                            {terms.sections.map((section, idx) => (
                                <div key={idx} className="space-y-6">
                                    <div className="flex items-center gap-3">
                                        <span className="text-sky-500 font-mono text-xs font-bold leading-none">0{idx + 1}</span>
