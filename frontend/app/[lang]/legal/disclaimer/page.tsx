...
export default async function DisclaimerPage({ params }: Props) {
    const { lang } = await params;
    return (
        <div className="max-w-4xl mx-auto p-8 text-slate-800 dark:text-slate-300">
            <h1 className="text-3xl font-bold mb-6 text-slate-900 dark:text-white">Financial Disclaimer</h1>

            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-500/50 p-6 rounded-xl mb-8">
                <h2 className="text-xl font-bold mb-4 text-red-600 dark:text-red-500">Not Investment Advice</h2>
            ...
            <section className="mb-8">
                <h2 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">No Fiduciary Duty</h2>
                <p className="mb-4">
            ...
            <section className="mb-8">
                <h2 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">Risk Warning</h2>
                <p className="mb-4">
